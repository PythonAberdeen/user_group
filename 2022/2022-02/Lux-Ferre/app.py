...
server = app.server
app.title = 'My cool app' # This is the heading in the browser tab

# Create layout
app.layout = html.Div([
    # Heading of the app
    html.Div([
        html.H1(children='My super cool web app'), # Children here is the text of H1 html tag
        html.H3(children='by Arturo Regalado')
